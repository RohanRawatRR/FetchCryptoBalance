...
export default function Register() {
    ...
    const ethWalletAddress = useRef(undefined)
    ...
    async function onSubmitForm(event) {
        ...
        const data = {
            ...
            ethereum_wallet_address: ethWalletAddress.current.value
          };
    ...
    return (
        <div className='container'>
            ...
            <form onSubmit={onSubmitForm}>
                ...
                <div className="mb-3">
                    <input type="text" placeholder='Ethereum Wallet Address' autoComplete='off' className='form-control' id="ethereumAddress" ref={ethWalletAddress} />
                </div>
                <div className="mb-3">
